...
public class HSSFOptimiser {
    ...
    public static void optimiseFonts(HSSFWorkbook workbook) {
        ...
        // Update the new positions based on deletes
        // that have occurred between the start and them.
        ...
        // Tell HSSFWorkbook that it needs to re-start its HSSFFontCache
        workbook.resetFontCache();

        // Update the cell styles to point at the new locations of the fonts
    ...
    public static void optimiseCellStyles(HSSFWorkbook workbook) {
        ...
        // Zap the un-needed user style records removing by index,
        // because removing by object may delete styles we did not
        // intend to (the ones that _were_ duplicated and not the duplicates)
