 ...
 * ====================================================================
 */
package org.apache.poi.xssf.streaming.value;

import org.apache.poi.ss.usermodel.CellType;
import org.apache.poi.util.Internal;

/**
 * Represents the value of a cell of String Type
 */
@Internal
public abstract class StringValue implements Value
{
    ...
    public abstract boolean isRichText(); // using the POI style which seems to avoid "instanceof".
}
