...
public class AgileDecryptor extends Decryptor {
    ...
    public boolean verifyPassword(String password) throws GeneralSecurityException {
         ...
         */
        byte[] verifierInputEnc = hashInput(ver, pwHash, kVerifierInputBlock, ver.getEncryptedVerifier(), Cipher.DECRYPT_MODE);
        setVerifier(verifierInputEnc);
        MessageDigest hashMD = getMessageDigest(ver.getHashAlgorithm());
        byte[] verifierHash = hashMD.digest(verifierInputEnc);
