...
public final class HSSFFontFormatting implements org.apache.poi.ss.usermodel.FontFormatting {
    ...
    /**
     * Gets the type of super or subscript for the font.
     *
    ...
    /**
     * Gets whether the font weight is set to bold or not.
     *
    ...
    /**
     * Sets font style options to default values (non-italic, non-bold).
     */
    ...
    /**
     * Sets the escapement type for the font.
     *
    ...
    /**
     * Sets the type of underlining type for the font.
     *
