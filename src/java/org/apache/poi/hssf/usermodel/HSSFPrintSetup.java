...
public class HSSFPrintSetup implements PrintSetup {
    ...
    /**
     * Sets the number of pages wide to fit the sheet in.
     *
    ...
    /**
     * Sets the number of pages high to fit the sheet in.
     *
    ...
    /**
     * Sets whether to go left to right or top down in ordering.
     *
    ...
    /**
     * Sets whether to print in landscape.
     *
     * @param ls landscape
     */
    ...
    /**
     * Sets whether it is black and white.
     *
    ...
    /**
     * Sets whether it is in draft mode.
     *
     * @param d draft
     */
    ...
    /**
     * Sets wether it prints the include notes.
     *
    ...
    /**
     * Sets whether to use page start.
     *
