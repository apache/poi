...
@Beta
public class XDDFScatterChartSeries extends XDDFChartSeries {
	private CTScatterSer series;
	private CTScatterChart chart;

	public XDDFScatterChartSeries(XSSFSheet sheet, CTScatterChart chart, Map<Long, XDDFCategoryAxis> categories, Map<Long, XDDFValueAxis> values) {
		super(sheet);
		this.chart = chart;
