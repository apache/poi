...
@Beta
public class XDDFBarChartSeries extends XDDFChartSeries {
	private CTBarSer series;
	private CTBarChart chart;

	public XDDFBarChartSeries(XSSFSheet sheet, CTBarChart chart, Map<Long, XDDFCategoryAxis> categories, Map<Long, XDDFValueAxis> values) {
		super(sheet);
		this.chart = chart;
