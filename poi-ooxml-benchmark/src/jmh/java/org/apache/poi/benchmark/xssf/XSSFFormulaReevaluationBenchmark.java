 ...
 * cache. This is what {@link XSSFFormulaEvaluationBenchmark} does not measure: the cost of a
...
@Threads(1)
@State(Scope.Thread)
public class XSSFFormulaReevaluationBenchmark {
    ...
    public void setUp() {
        ...
        fe = XSSFFormulaEvaluator.create(wb, null, null);
        fe.evaluateAll();
    }
