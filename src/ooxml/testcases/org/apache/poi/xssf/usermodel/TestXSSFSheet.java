...
public final class TestXSSFSheet extends BaseTestSheet {
    ...
    public void groupUngroupColumn() throws IOException {
        ...
        assertEquals(1, sheet.getColumnOutlineLevel(4));
        ...
        assertEquals(0, sheet.getColumnOutlineLevel(9));
        ...
        assertEquals(2, sheet.getColumnOutlineLevel(2));
        assertEquals(1, sheet.getColumnOutlineLevel(3));
        assertEquals(1, sheet.getColumnOutlineLevel(4));
        assertEquals(1, sheet.getColumnOutlineLevel(5));
        assertEquals(1, sheet.getColumnOutlineLevel(6));
        ...
        assertEquals(1, sheet.getColumnOutlineLevel(4));
        assertEquals(1, sheet.getColumnOutlineLevel(5));
        assertEquals(2, sheet.getColumnOutlineLevel(6));
        assertEquals(2, sheet.getColumnOutlineLevel(7));
        assertEquals(1, sheet.getColumnOutlineLevel(8));
        assertEquals(0, sheet.getColumnOutlineLevel(9));
        assertEquals(1, sheet.getColumnOutlineLevel(10));
        assertEquals(1, sheet.getColumnOutlineLevel(11));
        assertEquals(0, sheet.getColumnOutlineLevel(12));
        ...
        assertEquals(0, sheet.getColumnOutlineLevel(0));
        assertEquals(1, sheet.getColumnOutlineLevel(1));
        assertEquals(3, sheet.getColumnOutlineLevel(2));
        ...
        assertEquals(0, sheet.getColumnOutlineLevel(5));
        assertEquals(1, sheet.getColumnOutlineLevel(6));
        assertEquals(2, sheet.getColumnOutlineLevel(7));
        assertEquals(0, sheet.getColumnOutlineLevel(8));
        assertEquals(0, sheet.getColumnOutlineLevel(9));
        ...
        colArray = cols.getColArray();
        assertEquals(6, colArray.length);
    ...
    @Test
    public void groupUngroupColumnFor1stLevel() throws IOException {
    ...
    @Test
    public void groupUngroupColumnFor2ndLevel() throws IOException {
        Workbook workbook = new XSSFWorkbook();
        Sheet sheet = workbook.createSheet();
