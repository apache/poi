...
public class DVConstraint implements DataValidationConstraint {
    ...
    public static final class FormulaPair {
        ...
        private final Ptg[] formula1;
        private final Ptg[] formula2;
    ...
    private DVConstraint(int validationType, int comparisonOperator, String formula1,
                         String formula2, Double value1, Double value2, String[] excplicitListValues) {
        ...
        this.value1 = value1;
        this.value2 = value2;
        this.explicitListValues = excplicitListValues;
    }
    ...
    private DVConstraint(String listFormula, String[] excplicitListValues) {
        this(ValidationType.LIST, OperatorType.IGNORED, listFormula, null, null, null, excplicitListValues);
    }

    /**
     * Creates a number based data validation constraint.
     * The text values for expr1 and expr2 can be either standard Excel formulas or formatted number values.
     * If the expression starts with '=' it is parsed as a formula, otherwise it is parsed as a formatted number.
     *
    ...
    public boolean isListValidationType() {
        return validationType == ValidationType.LIST;
    }
    ...
    public boolean isExplicitList() {
        return validationType == ValidationType.LIST && explicitListValues != null;
    }
    ...
    /* package */ FormulaPair createFormulas(HSSFSheet sheet) {
        ...
        if (isListValidationType()) {
            ...
            formula1 = convertDoubleFormula(this.formula1, value1, sheet);
            formula2 = convertDoubleFormula(this.formula2, value2, sheet);
        }
    ...
    private Ptg[] createListFormula(HSSFSheet sheet) {
        if (explicitListValues == null) {
            ...
            return HSSFFormulaParser.parse(formula1, wb, FormulaType.DATAVALIDATION_LIST, wb.getSheetIndex(sheet));
        ...
        StringBuffer sb = new StringBuffer(explicitListValues.length * 16);
